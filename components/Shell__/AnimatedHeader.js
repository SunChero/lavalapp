...
const AnimatedHeader = ({animationRange , title , image}) => 
    <View style={styles.container} pointerEvents="none"> 
        <HeaderBackground animationRange={animationRange} />
        <Animated.View style={styles.container} pointerEvents="none">       
            <AnimatedText animationRange={animationRange} title={title}/>
            image && <AnimatedImage animationRange={animationRange} image={image}/>
        </Animated.View>       
    </View>
