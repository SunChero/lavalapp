...
const GET_SITE_URL = 'http://45.77.147.98/_web/export'
const NEWS_PAGE_URL = 'http://45.77.147.98/_web/newsPage?link='
...
class Store {
    ...
    // @action getPosts(stream_id){
    //     let streamref = '/posts/'  + stream_id
